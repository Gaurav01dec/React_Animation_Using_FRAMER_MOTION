...
export default function WelcomePage() {
  ...
  // in above useTransform first value is action , second value is the scrolling pixels from where to where,
  // and third array is any changes from initial to final 
